// ─── Enterprise SVG Icon Set ─────────────────────────────────────────────────
// Stroke-based icons (24×24 viewBox) — consistent with Lucide / Feather style.
// Usage: <Icon.Users size={16} color="#6366f1" />

const icon = (path, opts = {}) => {
  const { fill = "none", strokeLinecap = "round", strokeLinejoin = "round" } = opts;
  return function IconComponent({ size = 16, color = "currentColor", style, strokeWidth = 2 }) {
    return (
      <svg
        width={size}
        height={size}
...
export const Icon = {
  // Navigation / layout
  LayoutGrid: icon(<><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></>),
  Briefcase:  icon(<><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/><line x1="12" y1="12" x2="12" y2="12"/></>),
  ...
  UserCheck:  icon(<><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><polyline points="16 11 18 13 22 9"/></>),
  UserX:      icon(<><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="17" y1="8" x2="23" y2="14"/><line x1="23" y1="8" x2="17" y2="14"/></>),
  ...
  ShieldAlert:   icon(<><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></>),
  ...
  RefreshCw:  icon(<><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-.46-5.18"/><polyline points="1 20 1 14 7 14"/></>),
  ...
  Clipboard:  icon(<><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1"/></>),
  ...
  Trash:      icon(<><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14H6L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4h6v2"/></>),
  ...
  // Content
  MessageSquare: icon(<><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 0 2 2z"/></>),
  ...
  Lightbulb:  icon(<><path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1.3.5 2.6 1.5 3.5.8.8 1.3 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/></>),
};
