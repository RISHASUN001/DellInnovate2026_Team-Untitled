...
start_service "image-service"   "$ROOT/backend/image-service" "${IMAGE_SERVICE_PORT:-8004}" "api.main:app"
...
log "Tail logs: tail -f logs/case-service.log logs/chatbot-service.log logs/mcp-service.log logs/image-service.log"
echo ""
